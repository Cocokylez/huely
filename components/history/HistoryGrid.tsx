...
export function HistoryGrid({ authed }: { authed: boolean }) {
  ...
  const openProject = (id: string) => router.push(`/?open=${id}`);
  ...
  return (
    <div className="space-y-5">
      <header className="flex items-start justify-between gap-4">
        ...
        <Link
          href="/"
          className="flex flex-none items-center gap-1.5 rounded-full bg-[var(--ink)] px-3.5 py-2.5 text-[12px] font-bold text-[var(--paper)] shadow-[var(--shadow-sm)] transition hover:-translate-y-0.5"
        >
      ...
      {loading ? (
        ...
        <section className="overflow-hidden rounded-[24px] border border-[var(--line)] bg-[var(--card)] text-center shadow-[var(--shadow-sm)]">
          ...
          <div className="px-6 py-6">
            ...
            <Link
              href="/"
              className="mt-4 inline-flex items-center gap-2 rounded-full bg-[var(--accent)] px-5 py-3 text-[12px] font-bold text-white"
            >
              <Icon name="camera" size={16} /> Start a project
            </Link>
          </div>
        </section>
      ) : (
            ...
            <>
              ...
              <section>
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-[var(--ink-soft)]">{visible.length} shown</span>
                </div>
                <div className="grid grid-cols-1 gap-3 min-[420px]:grid-cols-2">
                  ...
                  <Link
                    href="/"
                    className="grid min-h-[200px] place-items-center rounded-[18px] border-2 border-dashed border-[var(--line)] bg-[var(--paper-2)]/45 text-center text-[12px] font-semibold text-[var(--ink-soft)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
                  >
                    <span className="flex flex-col items-center gap-2">
                      <span className="grid h-11 w-11 place-items-center rounded-2xl bg-[var(--card)] shadow-[var(--shadow-sm)]">
